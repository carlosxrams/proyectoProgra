...
INSERT INTO `clientes` VALUES (2,'Maria Antonieta','Lopez Blanco','123',_binary '','33331111','lopezblancogmail.com','2026-05-16 16:28:24');
...
CREATE TABLE `productos` (
  ...
  CONSTRAINT `fk_productos_marcas` FOREIGN KEY (`id_marca`) REFERENCES `marcas` (`id_marca`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `proveedores` VALUES (1,'Bimbo','123','Guatemala','66667777');
...
INSERT INTO `puestos` VALUES (1,'Conserje'),(2,'Guardia'),(3,'Contador'),(4,'Programador'),(5,'Secretaria'),(7,'Chofer'),(8,'Bodeguera'),(10,'Empaque'),(11,'Cuidador'),(12,'Vendedor'),(13,'Bodeguero'),(14,'Supervisora');
...
-- Dump completed on 2026-05-16 17:07:15
